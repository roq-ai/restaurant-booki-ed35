...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Restaurant booking engine v5`}</title>

        <meta
          name="description"
          content="Experience the ease of dining with Restaurant Booking Engine v5. Simplifying reservations for customers and streamlining management for restaurant staff."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Restaurant booking engine v5`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of dining with Restaurant Booking Engine v5. Simplifying reservations for customers and streamlining management for restaurant staff.`}
            </Text>
            <Box
